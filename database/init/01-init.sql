-- Storied Life Database Initialization
...
CREATE TYPE memorial_status AS ENUM ('active', 'archived', 'private');
...
CREATE TABLE IF NOT EXISTS memorials (
    ...
    status memorial_status DEFAULT 'active',
...
-- Create memorial_members table (for access control)
